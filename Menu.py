...
def VHS1():
       filename = 'social_distancing_v.py'
       os.system(filename)
       os.system('notepad'+filename)

def VHS2():
       filename = 'social_distancing_v1.py'
       os.system(filename)
       os.system('notepad'+filename)

def VHS3():
       filename = 'social_distancing_v2.py'
       os.system(filename)
       os.system('notepad'+filename)

def VHS4():
       filename = 'social_distancing_v3.py'
       os.system(filename)
       os.system('notepad'+filename)

def VHS5():
       filename = 'social_distancing_v4.py'
       os.system(filename)
       os.system('notepad'+filename)

def VHS6():
       filename = 'social_distancing_v5.py'
       os.system(filename)
       os.system('notepad'+filename)

def VHS7():
       filename = 'social_distancing_v6.py'
       os.system(filename)
       os.system('notepad'+filename)
